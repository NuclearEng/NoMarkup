...
const (
	...
	UserService_ChangePassword_FullMethodName            = "/nomarkup.user.v1.UserService/ChangePassword"
...
type UserServiceClient interface {
	...
	// ChangePassword is the authenticated, self-service password change. Unlike
	// ResetPassword (token-driven, for users who can't sign in) it re-authenticates
	// the caller by requiring their current password, then rotates all sessions.
