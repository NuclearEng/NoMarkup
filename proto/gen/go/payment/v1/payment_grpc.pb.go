...
const (
	...
	PaymentService_CreateStripeAccountSession_FullMethodName     = "/nomarkup.payment.v1.PaymentService/CreateStripeAccountSession"
	...
	PaymentService_SetDefaultPaymentMethod_FullMethodName        = "/nomarkup.payment.v1.PaymentService/SetDefaultPaymentMethod"
...
type PaymentServiceClient interface {
	...
	// Connect embedded components — AccountSession client_secret for
	// account_onboarding / notification_banner / account_management / payouts.
	CreateStripeAccountSession(ctx context.Context, in *CreateStripeAccountSessionRequest, opts ...grpc.CallOption) (*CreateStripeAccountSessionResponse, error)
...
func (c *paymentServiceClient) CreateStripeAccountSession(ctx context.Context, in *CreateStripeAccountSessionRequest, opts ...grpc.CallOption) (*CreateStripeAccountSessionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateStripeAccountSessionResponse)
	err := c.cc.Invoke(ctx, PaymentService_CreateStripeAccountSession_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentServiceClient) SetDefaultPaymentMethod(ctx context.Context, in *SetDefaultPaymentMethodRequest, opts ...grpc.CallOption) (*SetDefaultPaymentMethodResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetDefaultPaymentMethodResponse)
	err := c.cc.Invoke(ctx, PaymentService_SetDefaultPaymentMethod_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	...
	// Connect embedded components — AccountSession client_secret for
	// account_onboarding / notification_banner / account_management / payouts.
	CreateStripeAccountSession(context.Context, *CreateStripeAccountSessionRequest) (*CreateStripeAccountSessionResponse, error)
	// Customer payment methods
...
func (UnimplementedPaymentServiceServer) CreateStripeAccountSession(context.Context, *CreateStripeAccountSessionRequest) (*CreateStripeAccountSessionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateStripeAccountSession not implemented")
}
...
func (UnimplementedPaymentServiceServer) SetDefaultPaymentMethod(context.Context, *SetDefaultPaymentMethodRequest) (*SetDefaultPaymentMethodResponse, error) {
...
func _PaymentService_CreateStripeAccountSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateStripeAccountSessionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).CreateStripeAccountSession(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_CreateStripeAccountSession_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).CreateStripeAccountSession(ctx, req.(*CreateStripeAccountSessionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PaymentService_SetDefaultPaymentMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetDefaultPaymentMethodRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).SetDefaultPaymentMethod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_SetDefaultPaymentMethod_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).SetDefaultPaymentMethod(ctx, req.(*SetDefaultPaymentMethodRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateStripeAccountSession",
			Handler:    _PaymentService_CreateStripeAccountSession_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _PaymentService_SetDefaultPaymentMethod_Handler,
		},
		{
