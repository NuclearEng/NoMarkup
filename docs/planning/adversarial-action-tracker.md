...
**Recounted 2026-07-27** (ARC-11/14 Done; ARC-12/13 Demoted; FE-05 already Done; QA-08 already Done) (140 code/ops rows).
...
| P1 — North Star performance | 1 | 2 | 8 | 5 | 0 | 16 |
| P1 — CI / testing enforcers | 1 | 0 | 10 | 5 | 0 | 16 |
| P1 — Frontend / a11y / honesty | 1 | 2 | 8 | 5 | 0 | 16 |
| P2 — Architecture / polish | 1 | 0 | 8 | 9 | 0 | 18 |
| **All** | **10** | **6** | **94** | **29** | **1** | **140** |
...
| FE-04 | Loader2/spinners vs “Skeleton only” | MAJOR | web | many pages | Skeleton/ContentLoader for page load; spinner for button pending | Audit key routes | **Partial** 2026-07-27 — page-level loads now Skeleton/ContentLoader: AuthGuard, provider layout, /jobs/map, /orders list+detail, /marketplace browse + map side panel + spectate, /contracts/[id] page+review section + `/contracts/[id]/review` full page, /insurance/quotes + /disputes/new Suspense, InstantAvailabilityCard initial fetch, admin/payments fee config + admin/platform growth/category panels. Residual (not done): intentional button/action Loader2 (admin advances/insurance, contracts actions, InstantAvailability save); installment “processing” status icon spinner (status chrome, not page load); /jobs browse + some /me/* still use ad-hoc pulse divs (not shared Skeleton) | |
