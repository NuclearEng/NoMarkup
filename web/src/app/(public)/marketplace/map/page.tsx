...
export default function MarketplaceMapPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-4rem)] flex-col bg-background lg:h-[calc(100vh-4rem)]">
      {/* Header strip */}
      ...
      <div className="flex flex-1 flex-col overflow-hidden lg:flex-row">
        ...
        {/* Side panel — desktop */}
        <aside
          className="hidden w-full max-w-md overflow-y-auto border-l border-white/5 bg-background lg:block lg:w-[420px]"
        ...
        <div
          className={`lg:hidden ${sheetOpen ? 'h-[60vh]' : 'h-[80px]'} relative w-full overflow-hidden border-t border-white/10 bg-background transition-[height] duration-200`}
          aria-hidden={false}
        >
          <button
            type="button"
