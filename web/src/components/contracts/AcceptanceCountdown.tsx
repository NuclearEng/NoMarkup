...
export function AcceptanceCountdown({ deadline, compact = false }: AcceptanceCountdownProps) {
  ...
  if (compact) {
    ...
    return (
      <span className={cn('text-xs font-medium', colorClass)} aria-label="Acceptance deadline">
        {display} to accept
      </span>
    );
  }
  ...
  return (
    <div className={cn('font-medium', colorClass)} aria-label="Acceptance deadline countdown">
      <p className="text-xs uppercase tracking-wide text-muted-foreground">Acceptance Deadline</p>
