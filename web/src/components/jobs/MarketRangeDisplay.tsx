...
export function MarketRangeDisplay({
  ...
  if (compact) {
    return (
      <div
        className="rounded-lg bg-zinc-100 p-3 text-zinc-900 dark:bg-zinc-900/95 dark:text-white"
        role="figure"
      ...
      >
        ...
        <div className="mb-2 flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <BarChart3 className="h-3.5 w-3.5 text-zinc-500 dark:text-zinc-400" aria-hidden="true" />
        ...
        <div className="relative mb-2">
          <div className="relative h-1.5 w-full overflow-hidden rounded-full bg-zinc-300 dark:bg-zinc-800">
            <div
            ...
            {/* Median marker */}
            <div
              className="absolute top-0 h-full w-px bg-zinc-700/70 dark:bg-white/70"
  ...
  return (
    <div
      className="rounded-xl bg-zinc-100 p-4 text-zinc-900 dark:bg-zinc-900/95 dark:text-white sm:p-5"
      role="figure"
    ...
    >
      ...
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <BarChart3 className="h-4 w-4 text-zinc-500 dark:text-zinc-400" aria-hidden="true" />
          <h4 className="text-xs font-bold tracking-widest text-zinc-600 dark:text-zinc-300 uppercase">
            Market Intelligence
          </h4>
        </div>
        <Tooltip>
      ...
      <div className="relative">
        ...
        {/* The range track */}
        <div className="relative h-2 w-full overflow-visible rounded-full bg-zinc-300 dark:bg-zinc-800">
          {/* Gradient fill */}
          <div
            className="absolute inset-0 rounded-full"
            style={{
