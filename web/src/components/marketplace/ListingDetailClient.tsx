...
export function ListingDetailClient({ listingId, initialListing }: ListingDetailClientProps) {
  // Seed the query cache with the server-fetched listing so the first paint
  // renders real content (no loading skeleton). The query still refetches in
  // the background — invalidated by live bids and the spectator stream below.
