  ...
  return (
    <div className="rounded-lg border bg-card p-6">
      <div className="flex items-center gap-2">
        <Coins className="h-5 w-5 text-trust-high" aria-hidden="true" />
        <h3 className="font-semibold">Your Savings</h3>
      </div>
      <p className="mt-3 text-3xl font-bold text-trust-high">
      ...
      {totalSavingsCents > 0 ? (
        <div className="mt-3 flex items-center gap-1 text-sm text-trust-high">
