...
- [x] Grafana dashboards (request rates, latency, error rates)
- [x] Sentry integration for error tracking (frontend + backend)
- [x] OpenTelemetry distributed tracing across services
- [x] Alerting rules for SLA breaches

### 9.4 Security Hardening
- [x] Rate limiting with Redis (replace stub)
- [x] CSP headers configuration
- [x] CORS production allowlist
- [x] Secrets rotation procedure
- [x] Dependency vulnerability scanning (dependabot/renovate)
...
### 10.2 Optimization
- [x] Database query optimization (23 indexes added, unbounded queries limited)
- [x] Connection pooling tuning (PgBouncer configured: pool=100, max_client=500, max_db=150)
- [x] Redis caching for hot paths (categories, trust scores, rate limiting, idempotency)
- [x] Frontend bundle optimization (standalone output, Sentry tree-shaking, image optimization)
